...
;(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['templates/dest/js/jquery'], factory);
    } else if (typeof exports !== 'undefined') {
        module.exports = factory(require('templates/dest/js/jquery'));
    } else {
        factory(jQuery);
    }
